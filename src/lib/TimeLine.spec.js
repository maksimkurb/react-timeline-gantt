...
describe('TimeLine Initialization ', () => {
  it('Initilize properly when all properties are null', () => {
  ...
  it('Initialize on Size', () => {
    ...
    expect(wrapper.instance().initialize).toBe(false);
    ...
    expect(wrapper.instance().pxToScroll).toBe(
